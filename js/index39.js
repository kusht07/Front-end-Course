...
console.log(`My name is ${lastName} and it is ${lastName.length} characters long`);
console.log(`The difference between firstname and lastname is ${firstName.length - lastName.length}`);
